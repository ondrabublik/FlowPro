 ...
 * @author obublik
 */
abstract public class LinearSolver2 {

    public static SparseMatrix A;
    public static Preconditioner M;
    public static double[] b;

    public static LinearSolver2 solver;

    abstract public boolean solve(double[] x, double[] b);

    public static LinearSolver2 factory(Element[] elems, Parameters par) throws IOException {
